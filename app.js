...
===================================================== */
    ...
    const DRIVE_TIME_DATA = {
        COVERAGE: {
            "21_24": [13.46, 11.47, 10.93],
            "24_27": [13.35, 11.03, 7.73]
        },
        CRITIC: {
            "21_24": [13.19, 6.85, 6.25],
            "24_27": [9.85, 6.41, 3.79]
        },
        RF: {
            "21_24": [13.20, 7.14, 6.17],
            "24_27": [10.29, 6.98, 4.29]
        },
        XGB: {
            "21_24": [13.15, 7.22, 6.32],
            "24_27": [10.08, 7.08, 4.35]
        }
    };

    const HIGH_VERYHIGH_DATA = {
        CRITIC: {
            "21_24": { High: [11.96, 6.12, 6.15], VeryHigh: [21.39, 6.68, 9.01] },
            "24_27": { High: [12.75, 8.46, 4.28], VeryHigh: [8.36, 5.49, 3.15] }
        },
        RF: {
            "21_24": { High: [7.97, 4.53, 6.15], VeryHigh: [24.27, 5.25, 6.89] },
            "24_27": { High: [11.38, 8.08, 3.94], VeryHigh: [14.95, 6.57, 3.16] }
        },
        XGB: {
            "21_24": { High: [10.77, 5.26, 7.45], VeryHigh: [30.37, 4.47, 5.91] },
            "24_27": { High: [12.49, 7.52, 3.62], VeryHigh: [16.69, 6.68, 2.57] }
        }
    };
...
===================================================== */
    ...
    ===================================================== */
    const layers = {
        "Incidents Heatmap": new SafeTileLayer('./data/Incidents Heatmap', { pane: 'rasters' }),
        "Population Density": new SafeTileLayer('./data/Pop Density', { pane: 'rasters' }),
        "Fire Hydrants": new SafeTileLayer('./data/FireHydrants', { pane: 'rasters' }),
        "Road Density": new SafeTileLayer('./data/Road Density', { pane: 'rasters' }),
        "Number of Trucks Dispatched to Incidents": new SafeTileLayer('./data/Trucks', { pane: 'rasters' }),
        "NFPA Response Time": new SafeTileLayer('./data/NFPA RT', { pane: 'rasters' }),
        "Augmented Response Time": new SafeTileLayer('./data/ART', { pane: 'rasters' }),
    ...
    const colorSources = {
        ...
        "Road Density": layers["Road Density"],
        "Number of Trucks Dispatched to Incidents": layers["Number of Trucks Dispatched to Incidents"],
        "NFPA Response Time": layers["NFPA Response Time"],
        "Augmented Response Time": layers["Augmented Response Time"]
    };
